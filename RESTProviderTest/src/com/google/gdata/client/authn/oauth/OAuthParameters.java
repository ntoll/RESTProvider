...
/**
 * This is a slighly modified version to suit Linked IN. Added oauth_version and
 * callback to base map
 * 
 * 
 * Container for OAuth-related parameters. The parameters are divided into two
 * categories: those used to generate the signature base string, and other
...
public class OAuthParameters {
	...
	// OAuth related parameters, as defined in
	// http://oauth.net/core/1.0/#anchor3
	public static final String OAUTH_CALLBACK_KEY = "oauth_callback"; // not
	// used
	...
	public static final String OAUTH_SIGNATURE_METHOD_KEY = "oauth_signature_method"; // not
	// used
	public static final String OAUTH_TIMESTAMP_KEY = "oauth_timestamp";// not
	// used
	...
	public static final String OAUTH_VERIFIER_KEY = "oauth_verifier";// not used
	public static final String REALM_KEY = "realm";// not used
	public static final String XOAUTH_REQUESTOR_ID_KEY = "xoauth_requestor_id";// not
	// used
	...
	/**
	 * Returns any other parameters used in the OAuth process, such as the OAuth
	 * callback url.
	 * 
	 ...
	 * 
	 * @param key
	 *            The key used to reference this parameter. This key will also
	 *            be used to reference the value in the request url and in the
	 ...
	 * 
	 * @param key
	 *            The key used to reference this parameter.
	 */
	...
	/**
	 * Resets all transient parameters related to a single request, so that
	 * these parameters do not interfere with multiple requests.
	 */
	public void reset() {
	 ...
	 * the Consumer to identify itself to the Service Provider. This parameter
	 * is required for all OAuth requests. This parameter is included in the
	...
	/**
	 * Checks to see if the OAuth Consumer Key exists. Throws an exception if it
	 * does not. See {@link #getOAuthConsumerKey()} to learn more about this
	 * parameter.
	 * 
	 ...
	 * (such as HTTP)." This parameter is optional, and it will be supplied by
	...
	/**
	 * Checks to see if the OAuth nonce exists. Throws an exception if it does
	 * not. See {@link #getOAuthNonce()} to learn more about this parameter.
	 * 
	 * @throws OAuthException
	 *             if the OAuth nonce does not exist
	 */
	...
	/**
	 * Checks to see if the OAuth signature exists. Throws an exception if it
	 * does not. See {@link #getOAuthSignature()} to learn more about this
	 * parameter.
	 * 
	 * @throws OAuthException
	 *             if the OAuth signature does not exist
	 */
	...
	/**
	 * Sets the OAuth Signature Method. See {@link #getOAuthSignatureMethod()}
	...
	/**
	 * Checks to see if the OAuth signature method exists. Throws an exception
	 * if it does not. See {@link #getOAuthSignatureMethod()} to learn more
	 * about this parameter.
	 * 
	 * @throws OAuthException
	 *             if the OAuth signature method does not exist
	 */
	...
	/**
	 * Returns the OAuth timestamp. OAuth defines the timestamp as "the number
	 * of seconds since January 1, 1970 00:00:00 GMT. The timestamp value MUST
	 * be a positive integer and MUST be equal or greater than the timestamp
	 * used in previous requests." This parameter is optional, and will be
	 * supplied by {@link OAuthUtil#getTimestamp()} if it is not provided by the
	 * user. This parameter is included in the OAuth signature base string.
	 */
	...
	/**
	 * Checks to see if the OAuth timestamp exists. Throws an exception if it
	 * does not. See {@link #getOAuthTimestamp()} to learn more about this
	 * parameter.
	 * 
	 * @throws OAuthException
	 *             if the OAuth timestamp does not exist
	 */
	...
	public void setOAuthVersion(String version) {
		put(OAUTH_VERSION, version, baseParameters);
	}
	...
	/**
	 * Checks to see if the OAuth token exists. Throws an exception if it does
	 * not. See {@link #getOAuthToken()} to learn more about this parameter.
	 * 
	 * @throws OAuthException
	 *             if the OAuth token does not exist
	 */
	...
	/**
	 * Checks to see if the OAuth token secret exists. Throws an exception if it
	 * does not. See {@link #getOAuthTokenSecret()} to learn more about this
	 * parameter.
	 * 
	 * @throws OAuthException
	 *             if the OAuth token secret does not exist
	 */
	...
	/**
	 * Returns the OAuth Verifier. See {@link #getOAuthVerifier()} to learn more
	 * about this parameter.
	 */
	...
	/**
	 * Checks to see if the OAuth Verifier exists. Throws an exception if it
	 * does not. See {@link #getOAuthVerifier()} to learn more about this
	 * parameter.
	 * 
	 * @throws OAuthException
	 *             if the OAuth token secret does not exist
	...
	/**
	 * Sets the OAuth callback url. See {@link #getOAuthCallback()} to learn
	 * more about this parameter.
	 */
	public void setOAuthCallback(String oauthCallback) {
		put(OAUTH_CALLBACK_KEY, oauthCallback, baseParameters);
	}
	...
	/**
	 * Checks to see if the OAuth callback exists. Throws an exception if it
	 * does not. See {@link #getOAuthCallback()} to learn more about this
	 * parameter.
	 * 
	 * @throws OAuthException
	 *             if the OAuth callback does not exist
	 */
	 ...
	 * defined by <a
	 * href="http://tools.ietf.org/html/rfc2617#section-1.2>Section 1.2</a> of
	 * RFC 2617. This parameter is optional.
	 */
	...
	/**
	 * Sets the Realm parameter. See {@link #getRealm()} to learn more about
	 * this parameter.
	 */
	 ...
	 *            the key to remove
	 * @param params
	 *            the map to remove the key from
	 */
